                ...
                style="width:30px; position:relative; top:-3px; left:10px;"> </span>
                    ...
                    <li class="active treeview" style="border-bottom:1px solid gray; padding:5px;">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a class="active" href="searchJobOrder.php" style="font-size:11px;"><i
                    ...
                    <li class=" treeview" style="border-bottom:1px solid gray; padding:5px; margin-top:0px;">
                        ...
                        <ul class="treeview-menu">
                            <li><a class="" href="createTAIWANOrder.php" style="font-size:11px;">
                            <i class="fa fa-circle-o"></i>Create</a></li>
            ...
            <section class="content">
                <div class="searchPage shadow2" style="background:white; width:90%; margin-left:-45%;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-4">
                                <img src="./img/chinaFlag.png" alt="" style="width: 50px; margin-top: 23px;">
                            </div>
                            <div class="col-md-4 text-center">
                                <h3 class="text-center">Search Job Order</h3>
                            </div>
                        ...
                        <form action="#" id="filter">
                            <div class="col-md-2">
                                <div class=" input-group">
                                    ...
                                    <input type="text" class="form-control" data-provide="datepicker" id="from" data-date-format="yyyy-mm-dd" laceholder="To" value="" placeholder="From">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class=" input-group">
                                    <input t type="text" class="form-control" data-provide="datepicker" id="to" data-date-format="yyyy-mm-dd" laceholder="To" value="" placeholder="To">
                                </div>
                            </div>
                            <div class="col-md-2">
            ...
            if (jobCheck.length > 0) {
                $.ajax({
                    ...
                    .done(function(response) {
                        ...
                        // $("#empTable tbody tr td:nth-child(2)").each(function (e,ele) {                      
                        //    if(jQuery.inArray(ele.innerText, jobCheck) !== -1){
                        //         var e=e+1;
                        //         console.log("true");
                        //         $("#empTable tbody tr:nth-child("+e+") #jobCheck").prop("checked", true);
                        //    }                       
                        // })
                    })
            } else {
