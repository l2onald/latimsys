...
<head>
  ...
  <title>Latim Cargo & Trading | Search TAIWAN Order</title>
    ...
    <section class="sidebar">
      ...
      <br><br>
        ...
        <li class="active treeview" style="border-bottom:1px solid gray; padding:5px; margin-top:0px;">
          ...
          <ul class="treeview-menu">
            <li><a href="createTAIWANOrder.php" style="font-size:11px;"><i class="fa fa-circle-o"></i>Create</a></li>
            <li ><a class="active"href="searchTAIWANOrder.php" style="font-size:11px;"><i class="fa fa-circle-o"></i>Search</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper" >
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Search TAIWAN Order</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="searchPage shadow2" style="background:white; width:90%; margin-left:-45%;">
        ...
        <h3 style="text-align:center; color:black; font-weight:400; font-size:20px; padding:30px; margin-top:-30px; border-bottom:1px solid black;">Search TAIWAN Order
...
<style type="text/css">
 ...
 if ($level=='Seller') { 
                      ...
                      $consulta = mysqli_query($connect, "SELECT * FROM joborders WHERE agent_email='$email' AND branch='TAIWAN' AND fecha >= '$from' AND fecha < '$to'    ORDER BY id asc ") or die ("Error al traer los datos"); 
                    }else{

                      $consulta = mysqli_query($connect, "SELECT * FROM joborders WHERE agent_email='$email' AND branch='TAIWAN' ORDER BY id asc ") or die ("Error al traer los datos"); 
                    ...
                    $consulta = mysqli_query($connect, "SELECT * FROM joborders WHERE branch='TAIWAN' AND fecha >= '$from' AND fecha < '$to'  ORDER BY id asc ") or die ("Error al traer los datos");
                      }else{
                      $consulta = mysqli_query($connect, "SELECT * FROM joborders WHERE branch='TAIWAN' ORDER BY id asc ") or die ("Error al traer los datos");
                      }
                ...
                <tr>
                  ...
                  <td>
                    <a href="#" style=" text-align:center; position:relative;  top:16px; color:black; font-weight:500;">
                      ...
                      <center><img src="taiwanflag.png" style="width:30px; margin-top:10px;"></center>
                  </td>
