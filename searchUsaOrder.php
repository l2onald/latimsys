        ...
        <ul class="sidebar-menu">
          ...
          <li class="active treeview" style="border-bottom:1px solid gray; padding:5px; margin-top:0px;">
            ...
            <ul class="treeview-menu">
              ...
              <li><a class="active" href="searchUsaOrder.php" style="font-size:11px;"><i class="fa fa-circle-o"></i>Search</a></li>
            </ul>
          </li>
    ...
    <div class="content-wrapper">
      <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Search USA Order</li>
          </ol>
      </section>
      <section class="content">
          <div class="searchPage shadow2" style="background:white; width:90%; margin-left:-45%;">
            <div class="row" style="border-bottom: 1px solid #000; margin-left: 0; margin-right: 0;">
                <div class="col-md-12">
                  <div class="col-md-4">
                    <img src="./img/usaFlag.png" alt="" style="width: 50px; margin-top: 23px;">
                  </div>
                    <div class="col-md-4 text-center">
                        <h3 class="text-center">Search USA Order</h3>
                    </div>
