            ...
            <section class="sidebar">
                ...
                <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a class="active" href="searchTAIWANOrder.php" style="font-size:11px;"><i
            ...
            <section class="content">
                <div class="searchPage shadow2" style="background:white; width:90%; margin-left:-45%;">
                    <div class="row" style="border-bottom: 1px solid #000; margin-left: 0; margin-right: 0;">
                        <div class="col-md-12">
                            <div class="col-md-4">
                                <img src="./img/taiwanflag.png" alt="" style="width: 50px; margin-top: 23px;">
                            </div>
                            <div class="col-md-4 text-center">
                                <h3 class="text-center">Search TAIWAN Order</h3>
                            </div>
