...
$queryModel = mysqli_query($connect, "INSERT INTO tickets(type, service, name, supplier, supplier_phone, supplier_address, tracking_number, warehouse_receipt, notes, agent_name, agent_email, imagen1, imagen2, imagen3, status, fecha) 
                VALUES ('$type', '$service', '$name', '$supplier', '$supplier_phone', '$supplier_address', '$tracking_number', '$warehouse_receipt', '$notes', '$agent_name', '$agent_email', '$uploadfile_nombre1', '$uploadfile_nombre2', '$uploadfile_nombre3', 'PENDING', '$fecha')")
