  ...
  <?php if ($step=='1'){ ?>
      <div class="row" style="margin: 0px;"> 
        <div class="col-md-offset-2 col-md-8 shadow2" style="    background: white;margin-top:50px">
          <div class="row">
            <div class="col-md-12">
              <h3 style="text-align:center; color:black; font-weight:400; padding:20px; font-size:20px; border-bottom:1px solid #555555;">Create LATAM Order
              ...
              <div class="col-md-6">
                  ...
                  <div class="form-group row">
                      <div class="col-md-12" >
                        ...
                        <?php  
                        $consulta = mysqli_query($connect, "SELECT * FROM accounts WHERE type='Supplier' ORDER BY name asc ") or die ("Error al traer los datos");
            ...
            <div class="col-md-4">
              ...
              <div class="form-group row">
                  <div class="col-md-12">
                      <div class=" input-group">
                          <div class="input-group-addon"><i class="fa fa-user input-fa"></i></div>
                          <input type="text" name="customer_name" class="form-control" value="<?php echo $customer_name; ?>" disabled placeholder="customer_name">
              ...
              <div class="form-group row">
                  <div class="col-md-12">
                      <div class=" input-group">
                          ...
                          <input type="hidden"name="customer_company" value="<?php echo $customer_company; ?>">
                      </div>
                  </div>
              </div>              
              <div class="form-group row">
