  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="form_1 shadow2" style="width:600px; margin-left:-300px; background:white; height:300px;">

          <h3
            style="text-align:center; color:black; font-weight:400; padding:20px; font-size:20px; border-bottom:1px solid #555555;">
            Create Quotation<br>
            <span style="color:black; font-size:14px; font-weight:400; position:relative; top:10px;">Please select one
              option:</span>
          </h3>
          ...
          <div style="width:400px; position:relative; float:left; left:50%; margin-left:-200px; top:90px;">

            <span style="font-size:60px; position:absolute; top:-85px; left:50px;" class="fa fa-ship"></span>

            <a href="?step=2&option=FCL"><button type="button" class="btn btn-primary btn-lg"
                style="width:160px;border-radius:2px; position:relative; height:40px; background:#4C7C67; border:none;"
                onMouseOver="this.style.background='#007F46'" onMouseOut="this.style.background='#4C7C67'">
                <span style="position:relative; font-size:14px; top:-3px;">FCL Shipment</span>
              </button></a>

          </div>


          <div style="width:400px; position:relative; float:right; left:140px; top:90px;">

            <span style="font-size:60px; position:absolute; top:-80px; left:50px;" class="fa fa-cubes"></span>
            <a href="?step=2&option=Pieces"><button type="button" class="btn btn-primary btn-lg"
                style="width:160px;border-radius:2px; position:relative; height:40px; background:#B7565B; border:none;"
                onMouseOver="this.style.background='#B80008'" onMouseOut="this.style.background='#B7565B'">
                <span style="position:relative; font-size:14px; top:-3px;">By Pieces</span>
              </button></a>
          </div>
        ...
        <div class="form_1 shadow2" style="width:600px; margin-left:-300px; background:white; height:300px;">
          ...
          <div style="width:350px; position:relative; padding:20px; margin-top:-60px; left:50%; margin-left:-185px;">
            <h3
              style="text-align:center; color:black; font-weight:400; padding:20px; font-size:16px; border-bottom:1px solid #555555;">
              <br>

              <span style="font-size:35px; padding:10px; position:relative; left:95px; top:-8px; "
                class="glyphicon glyphicon-user"></span>

              <span style="position:relative; top:10px; position:relative; left:-25px; ">Select Client Account</span>
            ...
            <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal1"
              style="border-radius:2px; position:absolute; top:228px; left:140px; width:100px; height:25px; background:#B7565B; border:none;"
              onMouseOver="this.style.background='#B80008'" onMouseOut="this.style.background='#B7565B'">
              <span style="position:relative; font-size:12px; top:-13px; left:-10px;">Add new client</span>
            </button>
            ...
            <form action="?" method="get">
              ...
              <div class="input-group">
                ...
                <select data-placeholder="Select Client" name="client_name" class="form-control select2"
                  style="width:263px; " required="required">
              ...
              <input type="text" name="option" style="display:none;" value="<?php echo $option; ?>">
              <input type="text" name="step" style="display:none;" value="3">

              <input type="submit" value="Next" class="form_2_submit"
                style="top:5px; left:135px; font-size:16px; height:30px; width:100px;border-radius:2px;  background:#4C7C67;"
                onMouseOver="this.style.background='#007F46'" onMouseOut="this.style.background='#4C7C67'">
            </form>
